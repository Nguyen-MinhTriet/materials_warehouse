        ...
        <div class="leftside-menu">
            ...
            <a href="index.html" class="logo logo-light">
                <span class="logo-lg">
                    <img src="{{ asset('assets/system/kho_lua.webp')}}" alt="logo">
                </span>
                <span class="logo-sm">
                    <img src="{{ asset('assets/system/kho_lua.webp')}}" alt="small logo">
                </span>
            </a>
            ...
            <a href="index.html" class="logo logo-dark">
                <span class="logo-lg">
                    <img src="{{ asset('assets/system/kho_lua.webp')}}" alt="dark logo">
                </span>
                <span class="logo-sm">
                    <img src="{{ asset('assets/system/kho_lua.webp')}}" alt="small logo">
                </span>
